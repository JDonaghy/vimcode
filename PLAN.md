...
- [ ] **Win-GUI critical bug fixes (from GTK comparison)** — 4 critical + 5 medium bugs found by systematic GTK↔Win-GUI comparison: (1) tab close dirty check, (2) picker mouse interaction, (3) dialog button clicks, (4) QuitWithUnsaved handling, (5) fold-aware scrolling, (6) picker scroll interception, (7) VSCode selection clear on click, (8) cursor viewport tracking after scroll, (9) terminal tab switching. See BUGS.md for full list.
