# src/win_gui/mod.rs — Win-GUI Backend (5,782 lines)
...
- `on_mouse_down()` — click routing: dialog, context menu, title bar, nav arrows, activity bar, sidebar, scrollbar, editor
