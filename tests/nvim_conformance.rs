...
const KNOWN_DEVIATIONS: &[&str] = &[
    "op:2dw across line end",
    "op:3dw crossing lines",
    "op:cw on whitespace",
    "op:cw on punctuation",
    "op:cc keeps indent",
    "op:2cc",
    "op:d% before paren",
    "op:d/pat",
    ...
    "jump:% C-o",
    "jump:'a C-o",
    "jump:C-o after j 20 lines",
    "jump:C-o after (",
    "jump:g; after 2 changes same line",
    "jump:3<C-o>",
    "jump:C-o after ''",
    "search:* cursor not on word",
    "search:* on punctuation",
    "search:* then :s//",
    "search:/pat/e",
    "search:/pat/e+1",
    "search:/pat/e-1",
    ...
    "ins:insert Tab then BS (sts)",
    "ins:i with count and Esc cursor",
    "ins:A with count and CR",
    "ins:C-r register linewise mid line",
    "ins:C-r with tab in register",
    "ins:BS join with autoindent",
    "ins:i then Esc then . twice",
    "vis:Vjd",
    "vis:v$y p",
    "vis:gv after Vjd",
    "vis:vggd",
    ...
    "word:cw at eol punct",
    "to:daw on whitespace",
    "to:diw on whitespace",
    "to:diw punctuation",
    "to:daw punctuation",
    "to:d2aw",
    "to:d3iw",
    ...
    "misc:count then i on line start",
